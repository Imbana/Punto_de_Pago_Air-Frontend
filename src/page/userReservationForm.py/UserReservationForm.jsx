...
const UserReservationForm = () => {
    ...
    return (
        <>
            ...
            <header className="header m-3 d-flex justify-content-between align-items-center">
                <img
                    src={logo}
                    width="150"
                    height="60"
            ...
            <div className="m-5">
                ...
                <Container fluid className="mt-5">
                    <Row className="align-item-center">
                        {/* Imagen a la derecha */}
                        <Col md={6} className="position-relative d-flex align-items-center justify-content-center rounded-4" style={{ minHeight: '80vh' }}>
                            <img src={imgFlight} alt="Vuelos" className="img-fluid h-100 w-100 rounded-4 col-image" style={{ objectFit: 'cover' }} />
                        </Col>


                        {/* Formulario a la izquierda */}
                        <Col md={6} className="d-flex flex-column align-items-start justify-content-start rounded-4 col-form p-5" style={{ minHeight: '100vh' }}>
                            ...
                            <Form onSubmit={handleSubmit(onSubmit)} className="w-100">
                                ...
                                <div className="d-flex justify-content-end">
                                    <Button type="submit" variant="" className="mt-4 btn-booking">Reservar</Button>
                                </div>
                            </Form>
                        </Col>
